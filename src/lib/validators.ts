...
export const opportunitySchema = z.object({
  ...
  scheduledVisitDate: z.string().optional().nullable(),
  actualVisitDate: z.string().optional().nullable(),
  infoCompleteDate: z.string().optional().nullable(),
  quotationDueDate: z.string().optional().nullable(),
  quotationSentDate: z.string().optional().nullable(),
  status: z.enum([
    'PROGRAMADA',
    'VISITADA',
    'EN_ESPERA_INFORMACION',
