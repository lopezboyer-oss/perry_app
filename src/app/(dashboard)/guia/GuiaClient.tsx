    ...
    content: (
      <>
        ...
        <div className="space-y-3">
          {[
            { type: 'Rastrillo', color: 'bg-blue-500', bg: 'bg-blue-50 border-blue-100', desc: 'Recorrido y prospección en planta para detectar oportunidades y buscar trabajo. (IMPORTANTE: NO incluye levantamiento técnico ni toma de medidas; el levantamiento técnico corresponde a una Cotización o a una Ejecución).', examples: '"Recorrido en planta Ternium", "Prospección y búsqueda de trabajo en planta Metalsa"' },
            { type: 'Cotización', color: 'bg-amber-500', bg: 'bg-amber-50 border-amber-100', desc: 'Elaboración, costeo, estimación y seguimiento de cotizaciones. Incluye: todas las actividades para completar una propuesta técnico-económica, tales como levantamientos técnicos en sitio, toma de medidas, visitas con subcontratistas y reuniones técnicas.', examples: '"Levantamiento técnico para cotizar barandales $185K", "Elaboración presupuesto sistema contra incendio"' },
            { type: 'Ejecución', color: 'bg-green-500', bg: 'bg-green-50 border-green-100', desc: 'Trabajos físicos y operativos en sitio: instalaciones, reparaciones, mantenimientos, montajes, pruebas y levantamientos técnicos para ejecución.', examples: '"Instalación lámparas LED", "Reemplazo cableado nave 3", "Pruebas y levantamiento en sistema neumático"' },
            { type: 'Planeación', color: 'bg-purple-500', bg: 'bg-purple-50 border-purple-100', desc: 'Programación de trabajo, coordinación operativa, logística, asignación de recursos y elaboración y gestión de PERMISOS (permisos de trabajo en planta, permisos de fin de semana, tramitación de accesos y firmas).', examples: '"Elaboración de permisos de fin de semana", "Programación y logística de cuadrillas", "Solicitud y control de materiales"' },
            { type: 'Diseño', color: 'bg-rose-500', bg: 'bg-rose-50 border-rose-100', desc: 'Diseño de planos, cálculos estructurales, modelado CAD e ingeniería de detalle.', examples: '"Diseño de layout planta", "Cálculo estructural barandal", "Planos eléctricos"' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-xs text-slate-600 mb-4 leading-relaxed">
              Rastrillo, Ejecución, Planeación, Diseño, Actividades en Traila / Oficina, Capacitación y Soporte Interempresa. Estas actividades no requieren una fase intermedia de trazabilidad comercial.
            </p>
